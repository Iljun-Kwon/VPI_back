...
def merge_datasets():
    ...
    df_videos = df_videos.drop(columns=["saved_at", "video_length", "thumbnail_url"])
    ...
    #df: video_id, timestamp, view_count, like_count, comment_count, channel_id, title, published_at, is_short, category_id
    ...
    #df: video_id, timestamp, view_count, like_count, comment_count, channel_id, title, published_at, is_short, category_id, id, title_channel, title, handle, category,
